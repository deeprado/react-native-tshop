...
import {brands, letters} from '../data';
        ...
        <View
          ...
          letters.map((item, index) => {
            return (
              <TouchableOpacity
                key={index}
                onPress={this._indexPress.bind(this, item)}>
                <TextFix
                  style={{
                    color:
                      item === this.state.currentLetter
                        ? theme.primaryColor
                        : '#333',
                    fontSize:
                      item === this.state.currentLetter ? px2dp(36) : px2dp(20),
