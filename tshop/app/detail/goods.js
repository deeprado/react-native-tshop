...
import {logWarm, logErr} from '../utils/log';
...
export default class Goods extends React.Component {
      ...
      <View style={{flex: 1}}>
          ...
          <View style={styles.goodsInfo}>
            ...
            <View style={styles.labels}>
              {this.state.labelList.map(item => (
                <Image
                  ...
                  style={[
                    styles.labelImg,
                    {width: px(item.width), height: px(item.height)},
                  ]}
                  resizeMode="cover"
                  resizeMethod="resize"
                  source={{
            ...
            <View style={styles.goodsPrices}>
              <View style={[styles.priceInfo]}>
                <Text allowFontScaling={false} style={styles.price1}>
                  ￥
                  <Text allowFontScaling={false} style={{fontSize: px(50)}}>
              ...
              {(this.state.isInBond === 1 ||
                this.state.isForeignSupply === 2) && (
                <View
                  style={{
                    flexDirection: 'row',
                  ...
                  <Text allowFontScaling={false} style={styles.gou}>
                    海购政策
                  </Text>
                </View>
              )}
            ...
            <View style={styles.promotes}>
              <View style={styles.promotesBox}>
                ...
                />
                <Text allowFontScaling={false} style={styles.promoteTxt}>
                  一件包邮
                </Text>
              </View>
              <View style={styles.promotesBox}>
            ...
            <View style={styles.detailHead_}>
              <Text allowFontScaling={false} style={styles.detailHead}>
                图文详情
              </Text>
            </View>
            {/*图文详情的内容*/}
            <View style={styles.detail}>
              {/*图文中的规格*/}
              {this.state.detail['more_property'] &&
                this.state.detail['more_property'].length > 0 && (
                    ...
                    <View style={styles.spu_detailContentHeadBox_}>
                      <View style={styles.spu_detailContentHeadBox}>
                        <Text
                          allowFontScaling={false}
                          style={[
                            styles.detailContentHead,
                            styles.spu_detailContentHead,
                          ]}>
                          产品规格
                        </Text>
                        {this.state.detail['more_property'].map(
                          (prop, index) => (
                            <View
                              key={index}
                              style={[
                                styles.spu_detailPropBox,
                                {
                                  backgroundColor:
                                    index % 2 ? '#faf8fb' : '#fff',
                                },
              ...
              <View style={styles.consumer}>
                <View style={styles.consumerBox}>
                  <View style={styles.consumer_head}>
                    ...
                    <Text
                      allowFontScaling={false}
                      style={styles.collectionHeadTxt}>
                      消费者告知书
                    </Text>
                    <Image
                      source={{uri: require('../images/icon-consumer')}}
        ...
        <View style={styles.footer}>
          ...
          {this.state.limitStock === 0 ? (
            <TouchableOpacity>
              <View
                style={[styles.footerBuy, styles.footerBuy1, {width: px(620)}]}>
                <Text
                  allowFontScaling={false}
                  style={[styles.footerBuyTxt, styles.footerBuy1Txt]}>
                  已抢光
                </Text>
              </View>
            </TouchableOpacity>
        ...
        <Modal
          ...
          <View style={SpecificationsStyle.warp}>
            <TouchableOpacity
              activeOpacity={0.9}
              style={{width: px(750), flex: 1}}
              onPress={() => this.setState({priceBoxStatus: false})}
            />
            <View style={SpecificationsStyle.box}>
              <View style={SpecificationsStyle.detail}>
                ...
                <View
                  ...
                  <Image
                    style={SpecificationsStyle.coverImage}
                    source={{
                ...
                <View>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Text
                      allowFontScaling={false}
                      style={{fontSize: px(35), color: '#252426'}}>
                      ￥{Number(this.state.salePrice).toFixed(2)}
                    </Text>
                    <Text
                      allowFontScaling={false}
                ...
                <TouchableOpacity
                  ...
                  <View style={SpecificationsStyle.closeImageBox}>
                    <Image
                      style={SpecificationsStyle.closeImage}
              ...
              <View style={SpecificationsStyle.other}>
                <View style={SpecificationsStyle.spuCartMain}>
                  ...
                  <View style={SpecificationsStyle.quantityBox}>
                    <Text
                      allowFontScaling={false}
                      style={SpecificationsStyle.quantity}>
                      数量
                    </Text>
                    ...
                    <View style={SpecificationsStyle.quantityMain}>
                      <TouchableOpacity
                        ...
                        <View style={SpecificationsStyle.reduce}>
                          <Text style={SpecificationsStyle.reduceText}>
                            {' '}
                            -{' '}
                          </Text>
                        </View>
                      ...
                      <TouchableOpacity
                        ...
                        <View style={SpecificationsStyle.plus}>
                          <Text style={SpecificationsStyle.plusText}> + </Text>
                        </View>
                      </TouchableOpacity>
                    </View>
                  </View>
                  ...
                  {this.state.isBuyLimit === 1 && (
                    <View style={SpecificationsStyle.tipLimitBuy}>
                      <Text
                        style={SpecificationsStyle.tipLimitBuyTip}
                        allowFontScaling={false}>
                        {this.state.buyLimitMsg}
                      </Text>
                    </View>
                  )}
                  {this.state.limitStock === 0 ? (
                    <TouchableOpacity
                      style={SpecificationsStyle.spuQuantityBtnBox}>
                      <View
                        style={[
                          styles.footerBuy,
                          styles.footerBuy1,
                    ...
                    <View style={SpecificationsStyle.spuQuantityBtnBox}>
                      <TouchableOpacity
                        activeOpacity={0.8}
                        onPress={this.addCartFn.bind(this)}>
                        <View
                          style={[
                            SpecificationsStyle.quantityBtn,
                            SpecificationsStyle.quantityBtnColor2,
                          ]}>
                          <Text
                            allowFontScaling={false}
                            style={SpecificationsStyle.quantityBtnText}>
                            加入购物车
                          </Text>
                        </View>
                      </TouchableOpacity>
                      <TouchableOpacity
                        ...
                        <View
                          style={[
                            SpecificationsStyle.quantityBtn,
                            SpecificationsStyle.quantityBtnColor1,
                          ]}>
                          <Text
                            allowFontScaling={false}
                            style={SpecificationsStyle.quantityBtnText}>
        ...
        {/*大图弹层*/}
        <ImgsModal
          ref={imgsModal => (this.imgsModal = imgsModal)}
      ...
      if (goods.detail.mobile_detail.list.length > 0) {
        goods.detail.mobile_detail.list.map(item => {
          if (Number(item.width) != 750) {
            try {
              item.height =
                ((750 / Number(item.width)) * Number(item.height)) >> 0;
              item.width = 750;
            } catch (e) {
              logWarm(e.message);
            }
  ...
  plus() {
    if (
      this.state.isBuyLimit == 1 &&
      this.state.buyNumber >= this.state.buyLimitNum
    ) {
