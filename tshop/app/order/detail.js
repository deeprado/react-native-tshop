        ...
        <ScrollView style={{flex: 1}}>
          ...
          <View style={styles.head}>
            <View>
              <Text
                ...
                style={[
                  styles.headTxt,
                  {fontSize: px(30), marginBottom: px(16)},
                ]}>
                {order.orderStatusNm}
              </Text>
            </View>
            <View style={styles.rows}>
              <Text
                ...
                style={[
                  styles.headTxt,
                  {fontSize: px(24), marginBottom: px(7)},
                ]}>
                订单编号 {order.orderNo}{' '}
              </Text>
              <TouchableWithoutFeedback>
                <View style={styles.copyBtn}>
                  <Text
                    ...
                    onPress={() => this.copy(order.orderNo)}>
                    复制
                  </Text>
                </View>
              </TouchableWithoutFeedback>
            ...
            <Text
              allowFontScaling={false}
              style={[styles.headTxt, {fontSize: px(24)}]}>
          ...
          <TouchableOpacity
            ...
            <View style={styles.addressInfo}>
              <Text allowFontScaling={false} style={styles.addressLine1}>
                {this.state.address.name} {this.state.address.phone}
              </Text>
              <Text allowFontScaling={false} style={styles.addressLine2}>
                {this.state.address.province}-{this.state.address.city}-
          ...
          <View style={styles.sectionBox}>
            <View style={styles.section}>
              <Text
                allowFontScaling={false}
                style={{fontSize: px(26), color: '#858385'}}>
                商品金额
              </Text>
              <Text
                allowFontScaling={false}
                style={{fontSize: px(28), color: '#858385'}}>
                ￥{order.prodAmount}
              </Text>
            </View>
          </View>
          ...
          <View style={styles.section2}>
            <View style={styles.section3}>
              <View style={styles.section4}>
                <Text
                  allowFontScaling={false}
                  style={{fontSize: px(28), color: '#252426'}}>
                  {order.orderStatus === 0 ? '应付金额' : '实付金额'}
                </Text>
                <Text
                  allowFontScaling={false}
                  style={{
          ...
          <View style={[styles.footer2, styles.footer]}>
            ...
            <View style={{flexDirection: 'row'}}>
              <Text
                ...
                style={[styles.cBtn, styles.cancelBtn]}
                allowFontScaling={false}>
                取消订单
              </Text>
              <Text
                onPress={this.pay.bind(this)}
                style={[styles.cBtn, styles.payBtn]}
                allowFontScaling={false}>
                去支付
              </Text>
            </View>
