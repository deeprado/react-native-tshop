...
export default class extends React.Component {
  ...
  render() {
    return (
      <View style={styles.container}>
          ...
          <View style={styles.order_detail}>
            ...
            <View style={styles.order_prop}>
              ...
              <Text
                ...
                style={[styles.amount, styles.txt]}>
        ...
        {this.state.pay === '1' && (
          <View>
            <Text allowFontScaling={false} style={styles.success_info}>
              您的订单将闪电发出，敬请期待
            </Text>
          </View>
        )}
  ...
  initData = async () => {
    this.setState({
      image:
        'http://imgbeta.daling.com/data/files/mobile/2016/06/08/14653741419171.jpg_710x440.jpg',
