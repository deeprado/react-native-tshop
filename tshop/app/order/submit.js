      ...
      <View style={{flex: 1}}>
        ...
        <ScrollView>
          ...
          <View style={styles.goodsShop}>
            <Text allowFontScaling={false} style={styles.goodsShopText}>
              疯狂紫萧的店铺
            </Text>
          </View>
          {/*商品列表*/}
          {this.state.goods &&
            this.state.goods.map(res => (
              <View
                key={res.id}
                style={{
          ...
          <View style={styles.otherBox}>
            <View style={{backgroundColor: '#fff'}}>
              {this.state.balanceAmount > 0 && (
                <View
                  style={[styles.coupon, {marginLeft: px(30), paddingLeft: 0}]}>
