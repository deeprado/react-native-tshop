      ...
      types.forEach((item, index) => {
        list.push(
          <TouchableOpacity
            ...
            />
            <Text style={styles.shareTxt} allowFontScaling={false}>
              {item.txt}
            </Text>
          </TouchableOpacity>,
        );
    ...
    return (
      <Modal
        ...
        <Animated.View
          ...
          {/*分享按钮*/}
          <View style={styles.list}>{this.list.map(item => item)}</View>
          {/*取消按钮*/}
          <TouchableOpacity
...
exports.SHARETYPE = {
  ...
  WEIXIN: {
    method: 'weiFriend',
    url: require('../images/icon-weixin'),
    txt: '微信好友',
  },
  /**
   * 微信朋友圈
  ...
  LIANJIE: {
    method: 'weiLink',
    url: require('../images/icon-share-link'),
    txt: '链接',
  },
  /**
   * 二维码
  ...
  ERWEIMA: {
    method: 'weiCode',
    url: require('../images/icon-share-code'),
    txt: '二维码',
  },
};
