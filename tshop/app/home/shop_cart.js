        ...
        <View style={styles.goods_list}>
            ...
            <View style={styles.operatingBtn}>
              <TouchableOpacity
                ...
                {this.props.editorArr.indexOf(this.props.items.id) < 0 ? (
                  <Image
                    source={{
                      uri: require('../images/tab-shopping-cart-select'),
                    }}
                    resizeMode="cover"
                  ...
                  <Image
                    source={{
                      uri: require('../images/tab-shopping-cart-selected'),
                    }}
                    resizeMode="cover"
                    style={{width: px(34), height: px(34)}}
                  />
          ...
          <View style={styles.goods_img}>
            <TouchableOpacity onPress={() => this.props.goDetail()}>
              ...
              {this.props.items.limitStock > 0 &&
              this.props.items.limitStock < 10 ? (
                <View style={styles.goods_limit}>
                  <Text allowFontScaling={false} style={styles.goods_limit_txt}>
                    仅剩{this.props.items.limitStock}件
                  </Text>
                </View>
              ) : null}
            </TouchableOpacity>
              ...
              <Text
                ...
                style={[
                  ...
                  this.props.items.can_select === 0
                    ? styles.color_disabled
                    : '',
                ]}
                numberOfLines={2}>
                <Text allowFontScaling={false}>
                  {this.props.items.goodsShowDesc}
                </Text>
              </Text>
            </TouchableOpacity>
                ...
                <View style={styles.operatingBox}>
                  {this.props.items.quantity === 1 ? (
                    <TouchableOpacity activeOpacity={0.8}>
                      <View style={styles.reduce}>
                        <Text
                          allowFontScaling={false}
                          style={[styles.btn1, styles.color_disabled1]}>
                          -
                        </Text>
                      </View>
                    </TouchableOpacity>
                  ...
                  <View style={styles.inpBox}>
                    <TextInput
                      ...
                      onChangeText={txt =>
                        this.props.goodsChangeQty(this.props.items.id, txt)
                      }
                      autoFocus={false}
                  ...
                  <TouchableOpacity
                    activeOpacity={0.8}
                    onPress={CartList.plus.bind(
                      null,
                      this.props.items.id,
                      this.props.items.quantity,
                      this.props.items.isBuyLimit,
                      this.props.items.buyLimitNum,
                      this.props.items.buyLimitMsg,
                    )}>
        ...
        return (
          <View style={styles.footer}>
            ...
            <View style={styles.footerContent}>
              <Text allowFontScaling={false} style={[styles.footerContentTxt0]}>
                全部
              </Text>
              <TouchableOpacity activeOpacity={0.8} onPress={this.props.delete}>
                <View style={[styles.delete]}>
                  <Text allowFontScaling={false} style={styles.delete_txt}>
                    删除
                  </Text>
                </View>
              </TouchableOpacity>
      ...
      return (
        <View style={styles.footer}>
          <View style={styles.operatingBtn}>
            <TouchableOpacity
              ...
              {this.props.selectAllStatus ? (
                ...
                <Image
                  source={{uri: require('../images/tab-shopping-cart-select')}}
                  resizeMode="cover"
                  style={{width: px(34), height: px(34)}}
                />
              )}
          ...
          <View style={styles.footerContent}>
            <Text
              allowFontScaling={false}
              style={[styles.footerContentTxt0, styles.footerContentTxt1]}>
              全部
            </Text>
            <Text allowFontScaling={false} style={styles.footerContentTxt1}>
              合计
            </Text>
            <Text allowFontScaling={false} style={styles.footerContentTxt2}>
            ...
            <TouchableOpacity activeOpacity={0.8} onPress={this.props.submit}>
              <View
                style={[
                  styles.submit,
                  this.props.total_price > 0 ? '' : styles.submitDisabled,
                ]}>
                <Text allowFontScaling={false} style={styles.submit_txt}>
                  去结算({CartList.data.total_count})
                </Text>
              </View>
            </TouchableOpacity>
          </View>
...
export default observer(
  class extends React.Component {
    ...
    render() {
      return (
        <View
          style={{flex: 1, backgroundColor: '#f5f3f6', paddingBottom: px(100)}}>
          {/*顶部*/}
          <Header
            showLeft={false}
            style={{
              ...
              if (CartList.data.list.length === 0) {
                return (
                  <View style={styles.empty}>
                    <Text allowFontScaling={false} style={styles.empty_txt}>
                      购物车没有商品哦
                    </Text>
                    <TouchableOpacity
                      activeOpacity={0.8}
          ...
          />
          {CartList.data.list.length == 0 ? null : (
            <Footer
              editStatus={this.state.editStatus}
    ...
    editSelect(index) {
      ...
      this.setState({
        editorArr: this.state.editorArr.concat(),
        editSelectAllStatus,
      });
    }
    //编辑选中所有商品
