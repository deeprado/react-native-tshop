    ...
    return (
      <ScrollView style={{flex: 1}}>
        ...
        <TopHeader
          ...
          textStyle={{color: '#fff'}}
          rightBtn={
            <TouchableOpacity onPress={() => this.go('Setting')}>
        ...
        <TouchableWithoutFeedback>
          <View style={styles.head}>
            <Image style={styles.headImg} source={{uri: UserInfo.headImgUrl}} />
            <View style={{flex: 1, flexDirection: 'row'}}>
              <Text allowFontScaling={false} style={styles.headerName}>
                {UserInfo.name}
              </Text>
            </View>
            <Icon name="angle-right" size={px(40)} style={{color: '#fff'}} />
          </View>
        </TouchableWithoutFeedback>
        {/*3个快捷通道*/}
        <View style={styles.link}>
          <TouchableOpacity
            ...
            <Text
              ...
              style={[styles.linkRowTxt, styles.linkRowTxt1]}>
              我的订单
            </Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.9} style={styles.linkRow}>
            ...
            <Text allowFontScaling={false} style={styles.linkRowTxt2}>
              {UserInfo.stunnerTotalAmount}元
            </Text>
          </TouchableOpacity>
          <TouchableOpacity activeOpacity={0.9} style={styles.linkRow}>
            <Image
        ...
        <TouchableOpacity activeOpacity={0.8}>
          <View style={styles.link2}>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <Icon name="angle-right" size={px(40)} />
            </View>
          </View>
        </TouchableOpacity>
        {/*收入等*/}
        <View style={styles.income}>
          <TouchableWithoutFeedback>
            <View style={styles.incomeItem}>
              ...
              <Text allowFontScaling={false} style={styles.incomeTxt}>
                今日收入
              </Text>
            </View>
          </TouchableWithoutFeedback>
        ...
        <View style={styles.tools}>
          <TouchableWithoutFeedback>
            <View style={styles.toolsButton}>
              <Image
                style={[styles.toolsButtonImg, {width: px(52)}]}
                resizeMode="contain"
                source={{uri: require('../images/icon-profile-shop')}}
              />
              <Text allowFontScaling={false} style={styles.toolsButtonLabel}>
                店铺设置
              </Text>
            </View>
          </TouchableWithoutFeedback>
          <TouchableWithoutFeedback onPress={() => this.go('OrderList', {})}>
            <View style={styles.toolsButton}>
              <Image
                style={[styles.toolsButtonImg, {width: px(46)}]}
                resizeMode="contain"
          ...
          <TouchableWithoutFeedback>
            <View style={styles.toolsButton}>
              <Image
                style={[styles.toolsButtonImg, {width: px(44)}]}
                resizeMode="contain"
          ...
          <TouchableWithoutFeedback>
            <View style={styles.toolsButton}>
              <Image
                style={[styles.toolsButtonImg, {width: px(50)}]}
                resizeMode="contain"
        ...
        {/*客服电话*/}
        <TouchableWithoutFeedback
          onPress={() => Linking.openURL('tell://400-005-5566')}>
          <View style={styles.link2}>
            <Text allowFontScaling={false} style={styles.linkTxt}>
              客服电话
            </Text>
            <Text allowFontScaling={false} style={{color: '#44b7ea'}}>
              400-005-5566
            </Text>
          </View>
        </TouchableWithoutFeedback>
